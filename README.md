...
| The navbar menu (Home,project, About and Contact)        | When clicked a button displays the chosen section.                                                                        | Clicked on button                                                                       | Opens the chosen section.                                      | Pass      |
...
| -------------------------- | ----------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | ------------------------------------------------------------- | --------- |
| logo          | When clicked return the home page                                                           | Clicked logo                                                                           | Home page reloads                                             | Pass      |
| The navbar menu (Home, projects, About and Contact)        | When clicked a button displays the chosen section.                                                                        | Clicked on button                                                                       | Opens the chosen section.                                      | Pass      |
| Home section button links    | Once clicked on these links, they open on external tab                                                                                           | Clicked home button links                                                                | Opens external links                 | Pass      |
| Project section button links         | Once clicked on these links, they open on external tab                                                                               | Clicked project button links                                                                      | Opens external links                                     | Pass      |
| About section         | will display experience, achievements and image  tab                                                                               | Display info                                                                      | Opens display info                                     | Pass      |
| Contact section link          | Once clicked on these links, they open on external tab | Clicked contact button links                                                   | Opens external links                       | Pass      |
| All buttons - hover effect | Display white background and black color when hovered over.             | Hover over each button on the page                                                      | Each button displayed the correct styling when hovered over   | Pass      |
| Social links in footer     | Once clicked on these links, they open on external tab                                                | Clicked on each link                                                                    | The social links opened on external tab each                  | Pass      |
...
![index.html](assets/docs/HTML-valiadtor-check.png)
...
![style.css](assets/docs/CSS-validation-check.png)

***

    JavaScript jshint test

Tests and received couple of warning, couldn't fix it because of the deadline but will fix in the future. 

![Script.js](assets/docs/js-jshint.png)
...
![Mobile-lighthouse](assets/docs/mobile-lighthouse.png)

***

     Desktop lighthouse

![Desktop-lighthouse](assets/docs/desktop-lighthouse.png)
...
* Bootstrap - to save time and to make responsive.
* Gsap - JS to add animation.
